...
public class IdxReader {
    ...
    public static final String INPUT_IMAGE_PATH = config.props.getProperty("INPUT_IMAGE_PATH");
    public static final String INPUT_LABEL_PATH = config.props.getProperty("INPUT_LABEL_PATH");

    public static final String INPUT_IMAGE_PATH_TEST_DATA = config.props.getProperty("INPUT_IMAGE_PATH_TEST_DATA");
    public static final String INPUT_LABEL_PATH_TEST_DATA = config.props.getProperty("INPUT_LABEL_PATH_TEST_DATA");

    public static final int VECTOR_DIMENSION = 784; //square 28*28 as from data set -> array 784 items

    /**
     * @param size
     * @return labelled images
     */
    ...
    /**
     * @param inputImagePath  path of input images
     * @param inputLabelPath  path of input image labels
     * @param amountOfDataSet amount of the dataset
     * @return labelled images
     */
